...
def test_return_user(test_user):
    ...
    assert response.json() ['username'] == 'mayatest'
    assert response.json()['email'] == 'mayatest@gmail.com'
    assert response.json()['first_name'] == 'mayatest'
    assert response.json()['role'] == 'admin'
    assert response.json()['last_name'] == 'kk'
